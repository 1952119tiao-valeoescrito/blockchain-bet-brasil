        ...
        <div className="w-full max-w-4xl mx-auto flex flex-col gap-8 text-left">
            ...
            <InfoSection title="Guia Rápido: 4 Passos Para a Vitória">
                <ol className="list-decimal list-inside space-y-4">
                    ...
                    <li><strong>Monte sua Aposta:</strong> No formulário, preencha os 5 campos com seus prognósticos no formato X/Y (ex: 23/2), onde X e Y são números de 1 a 25. Em seguida, defina o valor da aposta em ETH/MATIC.</li>
                    <li><strong>Submeta e Confirme:</strong> Clique em 'Submeter Aposta' e aprove a transação que aparecerá na sua carteira. Sua aposta será registrada de forma segura e imutável na blockchain.</li>
