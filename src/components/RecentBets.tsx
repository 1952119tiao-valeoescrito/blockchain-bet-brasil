...
import { BlockchainBetBrasilAddress, BlockchainBetBrasilABI } from '@/lib/constants'; // Supondo que você tenha um arquivo assim
...
export function RecentBets() {
  ...
  const { data: apostas, isLoading, error } = useReadContract({
    address: BlockchainBetBrasilAddress, // ou contractAddress
    abi: BlockchainBetBrasilABI, // ou contractAbi
