// src/contracts/index.ts - O CORAÇÃO DO SEU PROJETO

// ✅ COLOQUE O ENDEREÇO DO SEU CONTRATO DEPLOYADO AQUI
export const bettingContractAddress = '0xD7ACd2a9FD159E69Bb102A1ca21C9a3e3A5F771B';

// ✅ COLE O ABI QUE VOCÊ COPIOU DO REMIX AQUI DENTRO DOS COLCHETES
...
] as const; // O `as const` é uma boa prática do TypeScript